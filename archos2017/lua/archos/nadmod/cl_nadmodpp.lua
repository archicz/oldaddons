...
hook.Add("HUDPaint", "NADMOD.HUDPaint", function()
	...
	if ent:IsValid() && !ent:IsPlayer() then
		...
		draw.SimpleText(text, "ARCHOS_Header", ScrW() - (Width / 2) - 20, ScrH()/2 - 200, ARCHOS.Colors["text"], 1, 1)
		draw.SimpleText(text2, "ARCHOS_Text", ScrW() - (w2 / 2) - 20, ScrH()/2 - 200 + Height, ARCHOS.Colors["text"], 1, 1)
		draw.SimpleText(text3, "ARCHOS_Text", ScrW() - (w3 / 2) - 20, ScrH()/2 - 200 + Height + h2, ARCHOS.Colors["text"], 1, 1)
	end
end)
