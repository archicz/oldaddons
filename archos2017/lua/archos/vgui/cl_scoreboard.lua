...
hook.Add("ScoreboardShow","ARCHOS_SCOREBOARD_SHOW",function()
	...
	for k,v in pairs(player.GetAll()) do
		...
		if v:IsAdmin() or v:IsSuperAdmin() or v:GetUserGroup() == "superadmin2" then
			Rank:SetPos(65,-75)
		...
		local Props = vgui.Create("DButton",Panel)
		Props:SetSize(16,16)
		Props:SetPos(685,35)
		Props:SetText("")
		Props:SetTooltip("Props: "..v:GetCount("props"))
		Props.Icon = Material("icon16/bricks.png")
		Props.Paint = function(s,w,h)
			surface.SetMaterial(s.Icon)
			surface.SetDrawColor(255,255,255,255)
			surface.DrawTexturedRect(0,0,w,h)
		end
