...
hook.Add("HUDPaint", "NADMOD.HUDPaint", function()
	...
	if ent:IsValid() && !ent:IsPlayer() then
		...
		draw.RoundedBox(2, ScrW() - (boxWidth + 4), (ScrH()/2 - 200) - 16, boxWidth, boxHeight, ARCHOS.Colors["background"])
		draw.SimpleText(text, "ARCHOS_Header", ScrW() - (Width / 2) - 20, ScrH()/2 - 200, Color(255, 255, 255, 255), 1, 1)
		draw.SimpleText(text2, "ARCHOS_Text", ScrW() - (w2 / 2) - 20, ScrH()/2 - 200 + Height, Color(255, 255, 255, 255), 1, 1)
		draw.SimpleText(text3, "ARCHOS_Text", ScrW() - (w3 / 2) - 20, ScrH()/2 - 200 + Height + h2, Color(255, 255, 255, 255), 1, 1)
	end
end)
